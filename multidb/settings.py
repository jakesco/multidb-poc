...
SECRET_KEY = 'django-insecure-g0j(j7s3+!a8)9*y*)d1kp6-&zi6kckhfd-gy+-h#-bc2x5sga'
...
MIDDLEWARE = [
    ...
    'multidb.core.routers.RouterMiddleware', # Router middleware before messages (after auth)
